...
const UpdateFireFighter = ({ isOpen, onClose, current }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            await FireFighterServices.updateFireFighter(data, current?._id).then((response) => {
                toast({
                    ...toastProps,
...
UpdateFireFighter.propTypes = {
    isOpen: PropTypes.bool.isRequired,
    onClose: PropTypes.func.isRequired,
    current: PropTypes.object.isRequired
}

export default UpdateFireFighter